        ...
        <div className="container next">
            <Row>
                <Col lg="4" className="weekly">
                    ...
                    <Carousel>
                        <Carousel.Item>
                            <img src="/assets/images/book.jpeg" className="d-block w-100" alt="First slide" />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img src="/assets/images/book2.jpeg" className="d-block w-100" alt="Second slide" />
                        </Carousel.Item>
                        <Carousel.Item>
                            <img src="/assets/images/book4.jpeg" className="d-block w-100" alt="Third slide" />
                        </Carousel.Item>
                    </Carousel>
                </Col>
                <Col lg="4" id="popular">
